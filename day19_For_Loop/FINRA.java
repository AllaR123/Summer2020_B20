...
public class FINRA {
    public static void main(String[] args) {
        ...
        /*
        1. Write a method which prints out the numbers from 1 to 100 but for numbers which are a multiple of both 3 and 5,
    ...
    ex:
        ...
        System.out.println("-------------------------------------------");
        for(int j = 1; j < 100; j++) {
            if (j % 2 != 0) {           // must be odd
                if (j % 3 == 0 && j % 5 == 0) {     // must be divisible by 3&5
                    System.out.print(j + " ");
                }
            }
        }
